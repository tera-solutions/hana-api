...
/**
 * Partial update of a draft/pending invoice — code, business and type are immutable.
 */
class UpdateInvoiceRequest extends FormRequest
{
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'parent_id' => ['description' => 'Parent id.', 'example' => 1],
            'enrollment_id' => ['description' => 'Source enrollment id.', 'example' => 1],
            'invoice_date' => ['description' => 'Issue date.', 'example' => '2026-06-15'],
            ...
            'note' => ['description' => 'Free-text note.', 'example' => 'Cập nhật ghi chú'],
            'items' => ['description' => 'Replacement line items (omit to keep existing).', 'example' => []],
