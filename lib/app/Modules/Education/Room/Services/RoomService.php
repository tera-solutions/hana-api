...
class RoomService
{
    ...
    public function checkSchedule($id, array $params): array
    {
        ...
        // Lessons generated by TimetableService are paired 1:1 with a ClassSession
        // (session_id set) and already counted above via $sessionConflicts — only
        // legacy/manual lessons without that link need checking here, to avoid
