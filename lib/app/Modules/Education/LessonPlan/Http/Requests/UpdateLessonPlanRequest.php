...
class UpdateLessonPlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'plan_code' => ['sometimes', 'required', 'string', 'min:2', 'max:50', 'regex:/^[a-zA-Z0-9_]+$/', Rule::unique('edu_lesson_plans', 'plan_code')->ignore($id)],
            'plan_name' => ['sometimes', 'required', 'string', 'min:2', 'max:255'],
